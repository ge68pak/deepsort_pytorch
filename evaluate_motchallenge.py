...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="MOT17/train/SDP")
    parser.add_argument(
        "--detection_dir", help="Path to detections.", default="resources/detections17_SDP/64CNN")
    parser.add_argument(
        "--output_dir", help="Folder in which the results will be stored. Will "
        "be created if it does not exist.", default="results/test")
    parser.add_argument(
